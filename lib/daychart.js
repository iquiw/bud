...
export default class DayChart {
   ...
   * @param {boolean} [optinos.showEstimate] - Whether to show estimation graphs.
   * @param {boolean} [optinos.showIdeal] - Whether to show ideal line graph.
   */
  ...
  draw(startDay, endDay, dueDay, burndown) {
    ...
    if (this.showIdeal) {
      datasets.push({
        label:'Ideal',
        backgroundColor: DayChart.fade(this.colorIdeal),
        borderColor: this.colorIdeal,
        type: 'line',
        fill: false,
        tension: 0,
        data: ideals,
